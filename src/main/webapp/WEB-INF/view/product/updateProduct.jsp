...
<script type="text/javascript" src="../../../../resources/static/javascript/calendar.js">
	...
	$(
			function() {
				...
				function fncUpdateProduct() {
					...
					$('form[name="detailForm"]').attr("method", "POST").attr(
							"action", '/product/updateProduct').attr("enctype",
	...
	<form name="detailForm">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<c:forEach var="fileName"
				items="${product.fileName.replace('[', '').replace(']', '')}">
				<img src="/images/uploadFiles/${fileName.trim()}" width="200px"
					height="200px" />
			</c:forEach>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
